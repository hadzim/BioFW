 ...
 * Plot x..y data
 */
Canvas plot(const plotdata_ref x, const plotdata_ref y);

/**
 * Plot x..y data, specify curve colour
 */
Canvas plot(const plotdata_ref x, const plotdata_ref y, Color colour);
 ...
 */
Canvas plot(const plotdata_ref x, func_ref f);

/**
 * Plot f(x) function, specify curve colour (use together with f(x) function)
 */
Canvas plot(const plotdata_ref x, func_ref f, Color colour);
...
void addMark(plotdata_ref x, plotdata_ref y, double xpos, double ypos, Color colour);

/** Set colour of graph to requested colour */
void setColor(plotdata_ref x, plotdata_ref y, Color colour);
